...
class CPGTaskEventTest {
  ...
  @Test
  fun `task event is created from a task request in preparation, based on the request`() {
  ...
  @Test
  fun `event registry resolves task request and task resource to CPGTaskEvent`() {
